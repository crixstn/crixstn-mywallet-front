...
import { HomeLayout, Header, RegisterScreen,Footer, Value,Total, TotalValue } from "./styled";
...
export default function HomePage(){
    ...
    return(
       <HomeLayout>
            ...
            <RegisterScreen>
                {transactions === [] ? <h2>Não há registros de <br/>entrada ou saida</h2> : transactions.map(
                    item => 
                    <div>
                        <div>
